...
`@auth0/ai-genkit` is an SDK for building secure AI-powered applications using [Auth0](https://www.auth0.ai/), [Auth0 FGA](https://docs.fga.dev)/[OpenFGA](https://openfga.dev) and [Genkit](https://firebase.google.com/docs/genkit).
